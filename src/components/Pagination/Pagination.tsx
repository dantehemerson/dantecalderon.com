...
export default React.memo(function Pagination({
  ...
  return (
    <div className="flex items-center justify-between mt-[10px] py-4">
      {/* Prev button */}
      <a
      ...
      >
        <img alt="Prev Page" src={imageSrc} className="transition duration-400 rotate-[-90deg] mx-[3px] m-0" />
      ...
      >
        ...
        <img alt="Next Page" src={imageSrc} className="transition duration-400 rotate-90 mx-[3px] m-0" />
      </a>
    </div>
  )
})
