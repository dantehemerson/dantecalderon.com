...
<div className="mdx-image-container with-border wone g1" style={{maxWidth: '430px', borderColor: 'red'}}>

![MongoDB actors](/images/a6dfe4142490406d84ecdf45501c378d/5fdfcc2b-de21-4cac-b680-7ecc09b72d35-Untitled-00c9ed53.png)

<figcaption className="gatsby-resp-image-figcaption font-bold">MongoDB actors</figcaption>
</div>
...
<div className="mdx-image-container with-border wone g1" style={{maxWidth: '400px', borderColor: 'red'}}>
...
<div className="mdx-image-container with-border wone g1" style={{maxWidth: '500px', borderColor: 'red'}}>
...
<figcaption className="gatsby-resp-image-figcaption">On the left a Cluster, on the right a Replica Set</figcaption>
</div>
...
<div className="mdx-image-container with-border wone g1" style={{maxWidth: '200px', borderColor: 'red'}}>
...
<figcaption className="gatsby-resp-image-figcaption">An Instance is a single machine</figcaption>
</div>
...
<figcaption className="gatsby-resp-image-figcaption">One of the machines in the Replica Set is failing</figcaption>
</div>
...
<div className="mdx-image-container with-border wone g1" style={{maxWidth: '450px', borderColor: 'red'}}>
...
<figcaption className="gatsby-resp-image-figcaption">A document JSON</figcaption>
</div>
...
<figcaption className="gatsby-resp-image-figcaption">JSON vs BSON</figcaption>
</div>
...
<div className="mdx-image-container with-border wone g1" style={{maxWidth: '340px', borderColor: 'red'}}>
...
<div className="mdx-image-container with-border wone g1" style={{maxWidth: '420px', borderColor: 'red'}}>
